    ...
    <table class="table table-bordered">
        ...
        <tbody>
            @foreach($normalizedData as $index => $row)
                <tr>
                    <td>{{ $index + 1 }}</td> <!-- Menampilkan ID atau nomor urut -->
                    <td>{{ $row['normalized_score_kpu'] }}</td>
                    <td>{{ $row['normalized_score_ppu'] }}</td>
                    <td>{{ $row['normalized_score_kua'] }}</td>
                    <td>{{ $row['normalized_score_mat'] }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
